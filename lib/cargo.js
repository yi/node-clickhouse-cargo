...
(function() {
  var CLUSTER_WORKER_ID, Cargo, DEFAULT_COMMIT_INTERVAL, EXTNAME_UNCOMMITTED, EventEmitter, FILENAME_PREFIX, MAX_COMMIT_PER_EXAM_ROUTINE, MIN_ROWS, MIN_TIME, NOOP, StaticCountWithinProcess, assert, cargoOptionToHttpOption, cluster, debuglog, fs, fsAsync, isThisLeader, os, path, promisify, qs, url;
  ...
  Cargo = class Cargo extends EventEmitter {
    ...
    async exam() {
      ...
      try {
        ...
        if (hasRotation || this.countRotation < 1) {
