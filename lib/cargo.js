...
(function() {
  var CLUSTER_WORKER_ID, Cargo, DEFAULT_COMMIT_INTERVAL, EXTNAME_UNCOMMITTED, FILENAME_PREFIX, MAX_COMMIT_PER_EXAM_ROUTINE, MIN_ROWS, MIN_TIME, NOOP, StaticCountWithProcess, assert, crypto, debuglog, detectLeaderWorker, fs, os, path, toSQLDateString;
  ...
  Cargo = class Cargo {
    ...
    exam() {
      ...
      this.flushToFile((err) => {
        ...
        fs.stats(this.pathToCargoFile, (err, stats) => {
