...
(function() {
  ...
  var CLUSTER_WORKER_ID, MAX_UDP_CONFIRM, NOOP, REG_MSG_VALIDATOR, RemoteClientPortByCargoId, SERVICE_HOST, SERVICE_PORT, SERVICE_TYPE, UDPEchoSrv, assert, cluster, debuglog, detectLeaderWorker, dgram, err;
...
// echo back
  ...
  detectLeaderWorker = function(cargoId, callbak = NOOP) {
