...
(function() {
  var NUM_OF_LINE, STATEMENT_CREATE_TABLE, STATEMENT_DROP_TABLE, STATEMENT_INSERT, TABLE_NAME, assert, createCargo, debuglog, fs, getClickHouseClient, isInited;
  ...
  describe("commit bulk", function() {
    ...
    it("records should be written into remote ClickHouse server", function(done) {
      ...
      stream.on('end', function() {
        ...
        assert(rows.length === NUM_OF_LINE, "unmatching row length");
