...
(function() {
  var ClickHouse, INIT_OPTION, NUM_OF_LINE, QUERY, STATEMENT_CREATE_TABLE, STATEMENT_DROP_TABLE, STATEMENT_INSERT, TABLE_NAME, _, assert, createCargo, debuglog, fs, getClickHouseClient, isInited, os, path;
