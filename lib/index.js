...
(function() {
  var CLUSTER_WORKER_ID, Cargo, CargoOptions, REG_INVALID_SQL_TABLE_NAME_CHAR, TABLE_NAME_TO_CARGO, assert, cargoOptionToHttpOption, cluster, createCargo, debuglog, eachSeries, err, examCargos, examOneCargo, fs, http, https, init, os, path, pathToConfig, profileConfig, profileName;
