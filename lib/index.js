...
(function() {
  var CLUSTER_WORKER_ID, Cargo, CargoOptions, STATEMENT_TO_CARGO, assert, cargoOptionToHttpOption, cluster, createCargo, debuglog, err, examCargos, fs, http, https, init, os, path, pathToConfig, profileConfig, profileName;
