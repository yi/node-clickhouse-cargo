...
(function() {
  var ClickHouse, ClickHouseClient, DEFAULT_BULK_TTL, MIN_BULK_TTL, STATEMENT_TO_CARGO, assert, createCargo, debuglog, err, examCargos, fs, init, os, path, pathToConfig, profileConfig, profileName;
